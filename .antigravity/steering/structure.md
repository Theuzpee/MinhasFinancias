...
├── agents/
│   └── agent-n8n.md            # Skill do Antigravity para configuração de nodes n8n
└── .antigravity/
...
- **`agents/` para skills do Antigravity** — arquivos markdown de orientação para o agente, com escopo em ferramentas específicas
